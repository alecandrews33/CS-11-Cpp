...
/* Function to initialize a UnitConverter object and return it. The
 * UnitConverter gets it rules from the specified filename (note that it
 * is pass by reference). Throws invalid argument exception if file can't
 * be opened.
 */
